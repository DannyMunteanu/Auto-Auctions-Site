...
public interface ModelRepository extends JpaRepository<Model, Long> {
    ...
    /**
     * Query for all models with given model name (Note can be different makes).
     * I.e. Fiat 124 Spider and Abarth 124 Spider
     *
    ...
    /**
     * Query for all models of a particular series.
     * I.e all BMW 3 series models of e92 series.
     *
