...
/**
 * A component used to store tokens (not yet expired) that are invalidated after logging out.
 * Also checks any token is member of blacklist.
 * As well as functionality to remove expired tokens (since server will reject them).
 *
...
public class JwtTokenBlacklist {
    ...
    final private Map<String, Date> jwtBlacklist = new HashMap<>();
