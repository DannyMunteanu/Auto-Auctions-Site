...
/**
 * Entity Class mapped to the Bid table in database.
 * Consists of the represented Bid entity.
 *
...
public class Bid {
     ...
     * This representation includes the bid ID, listing details, bid time, amount, and user information.
     *
