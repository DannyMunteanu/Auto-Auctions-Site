...
/**
 * Entity Class mapped to the Model table in database. Consists of the ModelID, Make, Series, Model
 * Name, Displacement and Cylinder count for the represented entity.
 *
...
public class Model {
  ...
  /** Default constructor. Initializes a new instance of the {@link Model} class. */
  public Model() {}
